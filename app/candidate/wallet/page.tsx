    ...
    <div className="p-8 space-y-8 max-w-7xl mx-auto text-white">
      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Credits never expire. Use them for auto-applies, AI CV reviews, and AI interviews.</p>
        </div>
        ...
        <div className="lg:col-span-2 bg-[#0F172A] border border-[#1E293B]/60 rounded-2xl p-6 flex flex-col justify-between space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4 border-t border-b border-[#1E293B]/60 py-4">
            <div>
              ...
              <p className="text-lg font-bold text-white mt-1">32</p>
            </div>
            <div>
              <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Auto-Applied</span>
              <p className="text-lg font-bold text-white mt-1">18 times</p>
            </div>
            <div>
