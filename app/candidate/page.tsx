      ...
      <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">Emirates company invited you to an AI interview. Complete to boost your shortlist odds.</p>
          </div>
        </div>
        <div className="flex items-center gap-3 self-start sm:self-center flex-shrink-0">
          <span className="text-xs font-bold text-slate-300 border border-slate-700 px-3 py-1.5 rounded-xl">Emirates interview</span>
          <Link href="/candidate/interview" className="flex items-center gap-1.5 bg-[#00D07C] hover:bg-[#00B96E] text-[#080C14] font-bold px-4 py-2 rounded-xl text-xs transition-all shadow-md shadow-[#00D07C]/10 active:scale-[0.98]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-2xl p-6 space-y-4">
            <div className="flex justify-between items-center">
              ...
              <button className="text-xs text-[#00D07C] font-semibold hover:underline">View all</button>
            </div>
              ...
              {applications.map((app, idx) => (
                <div key={idx} className="flex flex-col sm:flex-row sm:items-center justify-between py-4 first:pt-0 last:pb-0 gap-3">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-slate-500 font-medium">{app.company} • {app.applied}</p>
                  </div>
                  <div className="flex items-center gap-2.5 flex-shrink-0">
                    <span className="text-[10px] font-bold text-slate-400">ATS <span className="text-white">{app.ats}</span></span>
                    <span className={`text-[10px] font-bold border px-2.5 py-1 rounded-full ${app.stageColor}`}>{app.stage}</span>
                    <Link href="/candidate/interview" className="flex items-center gap-1 border border-slate-700/80 hover:bg-slate-800 text-slate-300 px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-2xl p-5 space-y-4">
            <div className="flex items-center gap-2 text-xs font-bold text-[#00D07C]">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-slate-500 font-medium text-right">5/8 sent</p>
            </div>
          </div>
          ...
          <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-2xl p-5 space-y-4">
            ...
            <Link href="/candidate/cv" className="w-full block text-center bg-[#00D07C] hover:bg-[#00B96E] text-[#080C14] font-bold py-2.5 rounded-xl text-xs transition-all active:scale-[0.98]">
              Improve CV
            </Link>
          </div>
