...
export default function CandidateInboxPage() {
  ...
  const chats = [
    { name: "Emirates NBD", role: "Hiring Team", lastMsg: "We would like to invite you for a virtual interview this Thursday.", time: "10:24 AM", unread: true, initials: "ENB" },
    { name: "Careem", role: "Talent Acquisition", lastMsg: "Your profile match score looks great. Let's schedule a call.", time: "Yesterday", unread: false, initials: "C" },
    { name: "STC Pay", role: "Recruiter", lastMsg: "Are you still open to remote opportunities in the region?", time: "Monday", unread: false, initials: "STC" },
  ];

  return (
    <div className="p-8 max-w-7xl mx-auto h-[calc(100vh-2rem)] flex flex-col space-y-6 text-white">
      <div>
        <h1 className="text-sm font-medium text-slate-400 uppercase tracking-widest">Candidate Workspace</h1>
          ...
          <div className="flex-1 p-6 overflow-y-auto space-y-4">
            <div className="flex flex-col space-y-1 items-start max-w-[70%]">
              <div className="bg-[#1E293B] text-slate-200 px-4 py-2.5 rounded-2xl rounded-tl-none text-xs">
                Hello Layla, we reviewed your profile and matching score. We would like to invite you for a virtual interview this Thursday. Are you available around 2:00 PM?
              </div>
            ...
            <div className="flex flex-col space-y-1 items-end max-w-[70%] ml-auto">
              <div className="bg-[#00D07C] text-[#080C14] px-4 py-2.5 rounded-2xl rounded-tr-none text-xs font-medium">
                Hello! Yes, Thursday at 2:00 PM GST works perfectly for me. Should I expect a Zoom link or a Google Meet invitation?
              </div>
