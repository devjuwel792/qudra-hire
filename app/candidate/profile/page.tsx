      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
          ...
          <div className="flex gap-8">
            ...
            <div className="flex-1 grid grid-cols-2 gap-5">
              ...
              <div className="col-span-2 space-y-1.5">
                ...
                <input type="text" defaultValue="Senior Product Designer (UX/UI)" className="w-full bg-background border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-ring" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
          ...
          <div className="relative">
            <textarea 
              rows={4} 
              defaultValue="Product designer with 7+ years of building mobile-first fintech in the GCC. I love design systems, comprehensive research in UX/UI, and close partnering with engineers to move fast without breaking trust."
