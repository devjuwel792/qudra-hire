    ...
    <div className="p-8 max-w-4xl mx-auto min-h-[calc(100vh-4rem)] flex flex-col justify-center text-white">
      ...
      {stage === "intro" && (
        <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-3xl p-8 md:p-10 space-y-8 shadow-2xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <span className=" font-bold text-slate-500 uppercase tracking-widest">Emirates NBD • AI Interview Invite</span>
          ...
          <div className="space-y-4 text-sm text-slate-300 font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
              <div className="p-4 rounded-2xl bg-[#0A0F1D]/60 border border-[#1E293B]/40 space-y-2">
                <span className=" text-slate-500 font-bold uppercase tracking-wider block">Duration & Format</span>
                <p className="text-white font-bold text-sm">4 Questions • ~10 mins</p>
                <p className=" text-slate-400">Up to 2 minutes of response time per question.</p>
              </div>
              <div className="p-4 rounded-2xl bg-[#0A0F1D]/60 border border-[#1E293B]/40 space-y-2">
                <span className=" text-slate-500 font-bold uppercase tracking-wider block">Requirements</span>
                <p className="text-white font-bold text-sm">Mic & Camera Enabled</p>
                <p className=" text-slate-400">Ensure you are in a quiet, well-lit environment.</p>
              </div>
            </div>
          </div>
      ...
      {stage === "checking" && (
        <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-3xl p-8 text-center space-y-6 shadow-2xl">
          ...
          <div>
            ...
            <p className=" text-slate-400 mt-1.5">Checking microphone, camera stream, and transcribing agent connection.</p>
          </div>
          <div className="max-w-xs mx-auto space-y-2.5  text-left font-semibold text-slate-400">
          ...
          <div className="flex-1 p-6 md:p-8 flex flex-col justify-between h-full">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                <span className=" font-bold text-[#00D07C] bg-[#00D07C]/10 border border-[#00D07C]/20 px-3 py-1 rounded-full">
            ...
            <div className="space-y-4 mt-6">
              <div className="flex justify-between items-center">
                <span className="text-[13px] font-bold text-slate-500 uppercase tracking-wider block">Write or Speak your response</span>
                <button
                  onClick={() => setIsListening(!isListening)}
                  className={`flex items-center gap-1.5 px-3 py-1 rounded-lg text-[13px] font-bold transition-all border ${isListening
          ...
          <div className="w-full md:w-64 border-t md:border-t-0 md:border-l border-[#1E293B]/60 bg-[#080C14] p-5 flex flex-col justify-between h-full">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className=" font-bold text-slate-400">Camera Feed</span>
              ...
              <div className="aspect-video md:aspect-square bg-slate-900 rounded-2xl border border-[#1E293B] relative overflow-hidden flex items-center justify-center">
                ...
                <div className="absolute inset-0 bg-gradient-to-tr from-[#162032] to-[#0A0F1D]/80 flex items-center justify-center flex-col">
                  ...
                  <span className="text-[13px] text-slate-400 mt-2 font-bold uppercase tracking-wider">Layla Al-Mansoori</span>
                </div>
            ...
            <div className="p-4 rounded-2xl bg-[#0F172A] border border-[#1E293B]/60 space-y-2 mt-4 md:mt-0">
              <div className="flex items-center gap-1 text-[13px] font-bold text-slate-400 uppercase tracking-wider">
      ...
      {stage === "submitting" && (
        <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-3xl p-8 text-center space-y-6 shadow-2xl">
          ...
          <div>
            ...
            <p className=" text-slate-400 mt-1.5">Generating semantic transcriptions, sentiment report, and skills alignment matrix.</p>
          </div>
        </div>
      )}
      ...
      {stage === "completed" && (
        <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-3xl p-8 md:p-10 text-center space-y-6 shadow-2xl max-w-xl mx-auto">
          ...
          <div className="bg-[#0A0F1D]/50 border border-[#1E293B]/40 rounded-2xl p-4  text-slate-400 leading-relaxed max-w-sm mx-auto">
