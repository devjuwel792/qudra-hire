  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#080C14] px-4 py-12">
      <div className="w-full max-w-[400px] bg-[#0F172A]/50 border border-white/5 rounded-3xl p-8 sm:p-10 shadow-2xl">
        ...
        <p className="text-slate-400 text-sm mb-8">Log in to continue progressing.</p>
        ...
        <form className="space-y-4">
          ...
          <button type="button" className="w-full bg-[#00D07C] hover:bg-[#00B96E] text-[#080C14] font-bold px-6 py-3 rounded-xl transition-all mt-2">
            Log in
          </button>
        </form>
