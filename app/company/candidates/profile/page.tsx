    ...
    <div className="p-8 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-2xl p-6 space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2.5 self-start md:self-center">
            ...
            <button className="flex items-center gap-1.5 bg-[#00D07C] hover:bg-[#00B96E] text-[#080C14] font-bold px-4 py-2.5 rounded-xl text-xs transition-all shadow-md shadow-[#00D07C]/10 active:scale-[0.98]">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pt-5 border-t border-[#1E293B]/60 gap-4">
          <div className="flex flex-wrap items-center gap-2.5">
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Set status:</span>
            {[
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Top Skills */}
          <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-2xl p-6 space-y-4">
            <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wider">Top skills</h3>
            <div className="flex flex-wrap gap-2">
              {["Figma", "Design Systems", "Fintech"].map((skill) => (
                <span 
                  key={skill} 
                  className="bg-[#162032] border border-[#2A3C58]/60 text-slate-300 text-xs font-bold px-3 py-1.5 rounded-lg"
                >
                  {skill}
                </span>
              ))}
          ...
          {/* AI Interview */}
          <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-2xl p-6 space-y-4">
            <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wider">AI interview</h3>
      ...
      <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-2xl p-6 space-y-5">
        <div className="flex justify-between items-center">
          ...
          <button className="flex items-center gap-1.5 border border-slate-700/80 hover:bg-slate-800 text-slate-300 px-4 py-2 rounded-xl text-xs font-bold transition-all">
        ...
        <div className="flex items-center justify-between bg-[#0A0F1D]/60 border border-[#1E293B]/30 rounded-xl p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Uploaded Mar 12 • 248 KB • Parsed by AI</p>
            </div>
          </div>
          <button className="text-xs font-bold text-[#00D07C] hover:underline px-3 py-1.5">
            View
          </button>
        </div>
      </div>
        ...
        <div className="space-y-6 pl-4 border-l-2 border-[#1E293B]/60">
          {[
            ...
            <div key={idx} className="relative space-y-1.5">
              ...
              <p className="text-xs text-[#00D07C] font-semibold">{exp.period}</p>
              <p className="text-xs text-slate-400 font-medium leading-relaxed mt-1">{exp.desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="bg-[#0F172A] border border-[#1E293B]/60 rounded-2xl p-6 space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-400 font-semibold">American University of Sharjah • 2015 — 2019</p>
        </div>
      </div>
